...
public class LaunchModelManager {
     ...
     * @return
     */
    public boolean checkLaunchModel(int launchModel, String activityReallyName) {
...
//            activityList.add(new PluginActivityItem(activity, launchModel, activityReallyName));
            ...
            return handleJudpe(index, launchModel, activityReallyName);
        }
    }

    private boolean handleJudpe(int index, int launchModel, String activityReallyName) {
        switch (launchModel) {
            case 0: { //标准模式
//                activityList.add(new PluginActivityItem(activity, launchModel, activityReallyName)); //直接启动
            ...
            case 1: { //SingleTop模式
                return handleSingleTop(index, launchModel, activityReallyName);
            }
            case 2: { //SingleTask模式
    ...
    private boolean handleSingleTop(int index, int launchModel, String activityReallyName) {
